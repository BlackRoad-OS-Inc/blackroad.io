# ROADMAP — blackroad.io

> Product roadmap for BlackRoad IO
...
- [ ] Deploy index.html to blackroad.io
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroad.io with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: BlackRoad OS, Prism Console, RoadSearch, RoadDocs, RoadAPI, Creator Studio
...
**Milestone**: First paying customer through blackroad.io.
...
**Milestone**: blackroad.io is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: platform | Products: BlackRoad OS, Prism Console, RoadSearch, RoadDocs, RoadAPI, Creator Studio*
